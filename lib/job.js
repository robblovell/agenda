...
Job.prototype.record = function(fail, complete) {
  this._scheduled = true;
  this.attrs.nextRunAt = undefined;
  if (fail !== null) {
    this.fail(fail);
    this.attrs.lastFinishedAt = new Date();
    this.attrs.lastFailedAt = this.attrs.lastFinishedAt;
  }
  else {
    this.attrs.data = complete
    this.attrs.lastFinishedAt = new Date();
    this.attrs.repeatAt = undefined;
    this.attrs.repeatInterval = undefined;
    this.attrs.repeatTimezone = undefined;
  }
